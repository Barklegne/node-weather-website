...
const forecast = (latitude, longitude, callback) => {
    ...
    request({
        ...
        if (error) {
            ...
            const chanceOfRain = body.forecast.forecastday[0].day.daily_chance_of_rain;
            const daySummary = body.forecast.forecastday[0].day.condition.text;

            callback(undefined, `${daySummary}, its currently ${currentDegrees} degrees out, there is ${chanceOfRain} chance of rain`);
        }
    })
}
